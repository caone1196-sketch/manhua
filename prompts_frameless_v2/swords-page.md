# PAGE OF SWORDS (P) — Frameless Wet-Manhwa v2

- **Slug:** `swords-page` | **Group:** swords
- **Emblem:** a sword with a feather plume
...
```text
A completely frameless vertical tarot card "PAGE OF SWORDS", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "PAGE OF SWORDS" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
FIGURE: 18 years old, build: **B** mảnh nhanh, dáng đứng trên đồi sẵn sàng, hair: windswept honey-brown hair cut in a sharp feathered pixie cut, eyes: honey-hazel sắc, almond, cảnh giác, skin: warm tan with glossy wet highlights, signature: sẹo nhỏ khía cằm, aura: đồi đá, gió sắc, dấu chân. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: an alert young woman page in a flowing cape on a windy mound holding one raised sword with both hands. Tarot emblem integrated naturally: a sword with a feather plume. COUNT LOCK — EXACTLY 1 SWORD (hard constraint; count before you draw).
The scene contains exactly 1 sword — not 0, not 2.
Placement is locked: exactly one sword, gripped in both hands; no dagger, no second blade.
...
At the bottom, centered: the title "PAGE OF SWORDS" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
