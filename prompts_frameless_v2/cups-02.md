# TWO OF CUPS (2) — Frameless Wet-Manhwa v2 · mode modern

- **Slug:** `cups-02` | **Group:** cups
- **Emblem:** two interlocked rings
...
```text
A completely frameless vertical tarot card "TWO OF CUPS", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "TWO OF CUPS" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
FIGURE: 21 years old, build: **A** mảnh, dáng nghiêng giao hòa uyển chuyển, hair: soft ash-brown hair worn in a low intertwined romantic braid, eyes: hazel-green mềm, upturned, say mê nhìn người kia, skin: fair with glossy wet highlights, signature: lúm đồng tiền má trái, aura: nước mưa, hứa hẹn, hoa táo. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: the card's symbolism re-staged in a modern luxury penthouse streamer studio: two interlocked rings rendered as a glowing holographic emblem above her, PC monitors and RGB neon ambient lighting, the suit objects arranged on her streaming desk, night city skyline bokeh through floor-to-ceiling windows. Tarot emblem integrated naturally: two interlocked rings. COUNT LOCK — EXACTLY 2 CHALICES (hard constraint; count before you draw).
The scene contains exactly 2 chalices — not 1, not 3.
Placement is locked: exactly two chalices, one raised in each lover's hand, one on the left and one on the right, both bowls fully visible and not overlapping — no third cup.
...
At the bottom, centered: the title "TWO OF CUPS" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
