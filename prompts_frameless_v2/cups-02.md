# TWO OF CUPS (2) — Frameless Wet-Manhwa v2
...
SCENE & SYMBOLISM: a swimwear-clad young woman and a swimwear-clad young man facing one another, her body turned three-quarters toward the viewer with one arm across her chest, each raising one chalice in a toast, a caduceus with a lion head above them. Tarot emblem integrated naturally: two interlocked rings. COUNT LOCK — EXACTLY 2 CHALICES (hard constraint; count before you draw).
