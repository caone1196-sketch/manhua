# SIX OF PENTACLES (6) — Frameless Wet-Manhwa v2 · mode modern

- **Slug:** `pentacles-06` | **Group:** pentacles
- **Emblem:** six pentacles on a scale
...
```text
A completely frameless vertical tarot card "SIX OF PENTACLES", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "SIX OF PENTACLES" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
FIGURE: 23 years old, build: **C** cân đối tử tế, dáng đứng phân phát, hair: well-groomed golden-brown hair in merchant styling, eyes: warm hazel, almond, rộng lượng thẳng thắn, skin: sand with glossy wet highlights, signature: khuyên vàng hình đồng xu ở dái tai trái, aura: chợ, bánh mì, tiếng đồng xu. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: the card's symbolism re-staged in a modern luxury penthouse streamer studio: six pentacles on a scale rendered as a glowing holographic emblem above her, PC monitors and RGB neon ambient lighting, the suit objects arranged on her streaming desk, night city skyline bokeh through floor-to-ceiling windows. Tarot emblem integrated naturally: six pentacles on a scale. COUNT LOCK — EXACTLY 6 PENTACLE COINS (hard constraint; count before you draw).
The scene contains exactly 6 pentacle coins — not 5, not 7.
Placement is locked: exactly six coins on the balance — three stacked in the left pan and three stacked in the right pan, 3 + 3 = 6; all six discs visible above the pan rims, no coins loose on the ground.
...
At the bottom, centered: the title "SIX OF PENTACLES" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
