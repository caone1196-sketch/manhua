# SIX OF PENTACLES (6) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `pentacles-06` | **Group:** pentacles
- **Emblem:** six pentacles on a scale
- **Phong cách phòng tắm:** Charity scales
...
FIGURE: 23 years old, build: **C** cân đối tử tế, dáng đứng phân phát, hair: well-groomed golden-brown hair in merchant styling, eyes: warm hazel, almond, rộng lượng thẳng thắn, skin: sand with glossy wet highlights, signature: khuyên vàng hình đồng xu ở dái tai trái, aura: chợ, bánh mì, tiếng đồng xu. Alluring pose: leaning forward over the vanity on both hands, weight low, looking into the lit mirror with a teasing smile, hips pushed back. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Charity scales): in a charity-spa bathroom: twin scale-shaped brass basins, warm generous amber light, six pentacle coins balanced across the scale beam — three stacked in the left pan and three stacked in the right pan. Tarot emblem integrated naturally: six pentacles on a scale. COUNT LOCK — EXACTLY 6 PENTACLE COINS (hard constraint; count before you draw).
The scene contains exactly 6 pentacle coins — not 5, not 7.
Placement is locked: exactly six coins balanced across the scale beam — three stacked in the left pan and three stacked in the right pan, 3 + 3 = 6; no coins loose on the floor
