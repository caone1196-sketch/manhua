# QUEEN OF WANDS (Q) — Frameless Wet-Manhwa v2 · mode modern
...
SCENE & SYMBOLISM: the card's symbolism re-staged in a modern luxury penthouse streamer studio: a sunflower wand between two flames rendered as a glowing holographic emblem above her, PC monitors and RGB neon ambient lighting, the suit objects arranged on her streaming desk, night city skyline bokeh through floor-to-ceiling windows. Tarot emblem integrated naturally: a sunflower wand between two flames. COUNT LOCK — EXACTLY 1 WAND (hard constraint; count before you draw).
