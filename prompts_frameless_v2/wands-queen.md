# QUEEN OF WANDS (Q) — Frameless Wet-Manhwa v2

- **Slug:** `wands-queen` | **Group:** wands
- **Emblem:** a sunflower wand between two flames
...
```text
A completely frameless vertical tarot card "QUEEN OF WANDS", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "QUEEN OF WANDS" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
FIGURE: 24 years old, build: **D** đầy đặn vừa, cong nữ tính, dáng ngồi hỏa diệm, hair: a magnificent mane of rich russet-red waves crowning her head, eyes: russet-amber, upturned, ấm mà thống trị, skin: honey with glossy wet highlights, signature: khuyên vàng hình mặt trời trên chân mày trái, aura: lửa ấm, da báo, gia vị. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: a serene queen with dark loosened hair on a lion-carved throne, wearing a soaking-wet micro string bikini with a glowing silk sash, one sunflower wand held gently in her hand, a black cat at her feet, her throne set at the edge of a bright spring birch grove — slender white birch trunks, soft green undergrowth and a carpet of wildflowers and sunflowers, dappled sunlight filtering through young leaves. Tarot emblem integrated naturally: a sunflower wand between two flames. COUNT LOCK — EXACTLY 1 WAND (hard constraint; count before you draw).
The scene contains exactly 1 wand — not 0, not 2.
Placement is locked: exactly one sunflower wand; no other staff.
...
At the bottom, centered: the title "QUEEN OF WANDS" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
