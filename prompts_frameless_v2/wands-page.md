# PAGE OF WANDS (P) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `wands-page` | **Group:** wands
- **Emblem:** a wand with a feather plume
- **Phong cách phòng tắm:** Art-deco plume
...
FIGURE: 18 years old, build: **A** nhỏ nhắn, nhanh nhẹn, dáng hăng hái, hair: short tousled ginger-auburn hair cut in a playful textured bob, eyes: ginger-amber, round, tò mò rực sáng, skin: fair with glossy wet highlights, signature: tàn nhang li ti trên hai cẳng tay, aura: nắng non, con đường, trống. Alluring pose: rising on tiptoe in a full-body stretch, arms overhead and intertwined, back arched, her whole figure one long alluring arc of light and water. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Art-deco plume): in an art-deco bathroom: fan-feather gold wall panels, playful yellow-gold accents, one living wand crowned with a bright feather plume standing in a slim vase on the vanity. Tarot emblem integrated naturally: a wand with a feather plume. COUNT LOCK — EXACTLY 1 WAND (hard constraint; count before you draw).
The scene contains exactly 1 wand — not 0, not 2.
Placement is locked: exactly one living wand crowned with a feather plume in the slim vase; no second staff
