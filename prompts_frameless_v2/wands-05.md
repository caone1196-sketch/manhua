# FIVE OF WANDS (5) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `wands-05` | **Group:** wands
- **Emblem:** five wands crossed in a star
- **Phong cách phòng tắm:** Arena star jets
...
FIGURE: 21 years old, build: **B** săn gọn, cơ mềm, dáng đấu tập linh hoạt, hair: short tousled copper-brown hair damp with exertion, eyes: hazel-green sắc, narrow, tập trung như so gươm, skin: sand with glossy wet highlights, signature: sẹo mảnh qua khớp ngón tay phải, aura: bụi đấu trường, tiếng gậy. Alluring pose: standing in sensual contrapposto, one hand resting on a popped hip, the other trailing water slowly down her collarbone, looking back over her shoulder with a smoldering half-smile. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Arena star jets): in an arena-spa bathroom: five rainfall jets set in a star burst on the dark tile wall, dynamic splash patterns on wet stone, five wands crossed together in one star bundle leaning against the tub rim. Tarot emblem integrated naturally: five wands crossed in a star. COUNT LOCK — EXACTLY 5 WANDS (hard constraint; count before you draw).
The scene contains exactly 5 wands — not 4, not 6.
Placement is locked: exactly five wands crossed together in one star bundle leaning against the tub rim — five shafts, five countable tips, no extra wand anywhere on the card
