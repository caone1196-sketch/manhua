# TEMPERANCE (XIV) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `14-temperance` | **Group:** major
- **Emblem:** a triangle within a square
- **Phong cách phòng tắm:** Zen ryokan ofuro
...
Placement is locked: exactly two chalices, one in each hand, trading one thin stream of water between them; both bowls fully visible and un-occluded
