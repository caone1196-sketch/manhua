# SIX OF CUPS (6) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `cups-06` | **Group:** cups
- **Emblem:** six chalices with flowers
- **Phong cách phòng tắm:** Retro pastel nostalgia
...
FIGURE: 19 years old, build: **A** nhỏ nhắn, mềm mại, dáng đứng dễ thương, hair: pale golden hair styled in a delicate maiden crown knot, eyes: baby-blue, doe, ngây thơ, skin: warm peach with glossy wet highlights, signature: bớt màu tím nhạt hình cánh hoa trên vai phải, aura: sân vườn, kẹo mật, ký ức. Alluring pose: caught mid-turn stepping out of the shower, glancing back at the viewer over her bare shoulder, water droplets flicking from her fingertips, hips mid-sway. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Retro pastel nostalgia): in a retro pastel bathroom: mint-and-pink fifties tile, vintage chrome faucets, warm memory-glow light, six chalices in one row along the shelf, each holding a different flower. Tarot emblem integrated naturally: six chalices with flowers. COUNT LOCK — EXACTLY 6 CHALICES (hard constraint; count before you draw).
The scene contains exactly 6 chalices — not 5, not 7.
Placement is locked: exactly six chalices in one row along the shelf, each holding a different flower; all six bowls separate and countable
