# FOUR OF PENTACLES (4) — Frameless Wet-Manhwa v2 · mode modern
...
SCENE & SYMBOLISM: the card's symbolism re-staged in a modern luxury penthouse streamer studio: four pentacles, one on the head rendered as a glowing holographic emblem above her, PC monitors and RGB neon ambient lighting, the suit objects arranged on her streaming desk, night city skyline bokeh through floor-to-ceiling windows. Tarot emblem integrated naturally: four pentacles, one on the head. COUNT LOCK — EXACTLY 4 PENTACLE COINS (hard constraint; count before you draw).
