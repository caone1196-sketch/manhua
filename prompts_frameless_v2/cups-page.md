# PAGE OF CUPS (P) — Frameless Wet-Manhwa v2
...
SCENE & SYMBOLISM: a graceful young woman page by the sea in an open robe sliding off one shoulder, holding one chalice from which a curious fish looks out. Tarot emblem integrated naturally: a chalice with a fish. COUNT LOCK — EXACTLY 1 CHALICE (hard constraint; count before you draw).
