# SEVEN OF SWORDS (7) — Frameless Wet-Manhwa v2 · mode modern
...
FIGURE: 20 years old, build: **A** mảnh nhẹ, dáng rón rén của kẻ trộm, hair: mischievous tousled dark chestnut hair, eyes: dark brown, cat, ánh mắt láu lỉnh lướt nhanh, skin: sand with glossy wet highlights, signature: sẹo trắng mảnh ngang lòng bàn tay phải, aura: bóng tối, bước chân lén, bạc. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: the card's symbolism re-staged in a modern luxury penthouse streamer studio: seven swords, two left behind rendered as a glowing holographic emblem above her, PC monitors and RGB neon ambient lighting, the suit objects arranged on her streaming desk, night city skyline bokeh through floor-to-ceiling windows. Tarot emblem integrated naturally: seven swords, two left behind. COUNT LOCK — EXACTLY 7 SWORDS (hard constraint; count before you draw).
The scene contains exactly 7 swords — not 6, not 8.
Placement is locked: five swords carried in his arms, held upright and fanned apart so that there are FOUR GAPS of clear sky between the five hilts — five hilts, four gaps — plus TWO swords planted upright in the grass behind him with ONE WIDE GAP of bare grass between them — two swords, one gap; 5 + 2 = 7. THIS CARD HAS ALREADY FAILED ONCE BY SHOWING NINE SWORDS: the usual mistake is drawing FOUR swords planted in the grass instead of two. Plant exactly TWO in the grass, never four, and count them: 1, 2.
