# NINE OF CUPS (9) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `cups-09` | **Group:** cups
- **Emblem:** nine chalices in an arc
- **Phong cách phòng tắm:** Skyline jacuzzi
...
FIGURE: 24 years old, build: **C** mềm mại cân đối, cong tự nhiên trung bình, hair: warm honey-brown hair in a relaxed loose chignon, eyes: amber-brown, upturned, cười cong như trăng, skin: honey with glossy wet highlights, signature: khuyên vàng hình hoa hồng nhỏ ở dái tai phải, aura: rượu ngọt, nến, ghế bành ấm. Alluring pose: rising on tiptoe in a full-body stretch, arms overhead and intertwined, back arched, her whole figure one long alluring arc of light and water. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Skyline jacuzzi): in a skyline-jacuzzi bathroom: a bubbling jacuzzi facing a panoramic city window, champagne and violet night glow, nine chalices arranged in a neat three-by-three grid on the glowing shelf behind the tub. Tarot emblem integrated naturally: nine chalices in an arc. COUNT LOCK — EXACTLY 9 CHALICES (hard constraint; count before you draw).
The scene contains exactly 9 chalices — not 8, not 10.
Placement is locked: exactly nine chalices on the glowing shelf in a neat 3 x 3 grid — three rows of three, 3 + 3 + 3 = 9; evenly spaced, all nine bowls fully visible
