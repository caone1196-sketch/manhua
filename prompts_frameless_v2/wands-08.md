# EIGHT OF WANDS (8) — Frameless Wet-Manhwa v2
...
```text
A completely frameless vertical tarot card "EIGHT OF WANDS", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "EIGHT OF WANDS" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
SCENE & SYMBOLISM: eight wands with leaf tips drifting in one parallel diagonal row across a soft open sky toward a river town below. Tarot emblem integrated naturally: eight parallel wands. COUNT LOCK — EXACTLY 8 WANDS (hard constraint; count before you draw).
