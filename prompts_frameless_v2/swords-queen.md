# QUEEN OF SWORDS (Q) — Frameless Wet-Manhwa v2 · mode modern
...
FIGURE: 24 years old, build: **B** cao thanh thoát, xương đòn nổi, dáng ngồi thẳng, hair: deep mahogany-red hair in an intricate woven crown braid, eyes: jade lạnh, hooded, sắc lẹm, skin: ivory with glossy wet highlights, signature: sẹo mảnh hình lưỡi kiếm trên xương đòn phải, aura: sương giá, trí tuệ, con dao giải phẫu. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: the card's symbolism re-staged in a modern luxury penthouse streamer studio: a sword wrapped in laurel rendered as a glowing holographic emblem above her, PC monitors and RGB neon ambient lighting, the suit objects arranged on her streaming desk, night city skyline bokeh through floor-to-ceiling windows. Tarot emblem integrated naturally: a sword wrapped in laurel. COUNT LOCK — EXACTLY 1 SWORD (hard constraint; count before you draw).
