# TEN OF PENTACLES (10) — Frameless Wet-Manhwa v2

- **Slug:** `pentacles-10` | **Group:** pentacles
- **Emblem:** ten pentacles in a tree-of-life pyramid
...
```text
A completely frameless vertical tarot card "TEN OF PENTACLES", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "TEN OF PENTACLES" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
WET FABRIC (match reference 2): soaking-wet bronze-gold micro string bikini — waterlogged darkened tone with translucent glossy sheen, clinging like a second skin with zero loose folds, plastered wet wrinkles, water droplets beading on the fabric surface, tiny drips falling from the fabric edges; whole body wet with droplets and thin rivulets, wet gleaming hair strands.

FIGURE: 22 years old, build: **C** mềm mại, dáng mẫu hệ hiền, hair: warm honey-brown hair in a thick braided crown, eyes: warm brown, almond, ấm áp trưởng giả, skin: warm peach with glossy wet highlights, signature: bớt hình chiếc lá sau tai trái, aura: gia tộc, bàn ăn, mùa gặt. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: a family hall — a patriarch seated, a couple standing with his hand at her waist, a child playing with two dogs — ten coins in a pyramid emblem on the wall behind them. Tarot emblem integrated naturally: ten pentacles in a tree-of-life pyramid. COUNT LOCK — EXACTLY 10 PENTACLE COINS (hard constraint; count before you draw).
The scene contains exactly 10 pentacle coins — not 9, not 11.
Placement is locked: exactly ten coins on the wall in a Tree-of-Life pyramid — 4 on the bottom row, 3 above them, 2 above those, 1 at the apex, 4 + 3 + 2 + 1 = 10; all ten discs countable, none hidden behind the figures.
...
At the bottom, centered: the title "TEN OF PENTACLES" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
