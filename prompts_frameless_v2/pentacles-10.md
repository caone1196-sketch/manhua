# TEN OF PENTACLES (10) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `pentacles-10` | **Group:** pentacles
- **Emblem:** ten pentacles in a tree-of-life pyramid
- **Phong cách phòng tắm:** Tree-of-life mosaic
...
FIGURE: 22 years old, build: **C** mềm mại, dáng mẫu hệ hiền, hair: warm honey-brown hair in a thick braided crown, eyes: warm brown, almond, ấm áp trưởng giả, skin: warm peach with glossy wet highlights, signature: bớt hình chiếc lá sau tai trái, aura: gia tộc, bàn ăn, mùa gặt. Alluring pose: seated sideways on the tub rim leaning back on one straight arm, chest lifted, one knee drawn up while the other leg trails toe-deep in the water, wet hair cascading down her back. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Tree-of-life mosaic): in a family-estate bathroom: a grand tree-of-life wall mosaic in gold and umber, dynasty-warm light, ten pentacle coins set into the mosaic branches in a pyramid — four on the bottom row, three above, two above, one at the apex. Tarot emblem integrated naturally: ten pentacles in a tree-of-life pyramid. COUNT LOCK — EXACTLY 10 PENTACLE COINS (hard constraint; count before you draw).
The scene contains exactly 10 pentacle coins — not 9, not 11.
Placement is locked: exactly ten coins in the tree-of-life mosaic in a pyramid — four on the bottom row, three above them, two above those, one at the apex, 4 + 3 + 2 + 1 = 10; all ten countable
