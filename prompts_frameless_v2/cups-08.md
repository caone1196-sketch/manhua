# EIGHT OF CUPS (8) — Frameless Wet-Manhwa v2

- **Slug:** `cups-08` | **Group:** cups
- **Emblem:** eight chalices stacked
...
```text
A completely frameless vertical tarot card "EIGHT OF CUPS", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "EIGHT OF CUPS" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
FIGURE: 23 years old, build: **B** mảnh gọn, bóng dáng lữ khách dứt khoát, hair: deep brown hair tucked under a travel cloak, eyes: deep brown, narrow, quyết tâm quay lưng, skin: light olive with glossy wet highlights, signature: sẹo nhỏ hình la bàn trên lòng bàn tay trái, aura: mưa, bước chân, núi xa. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: a solitary young woman in a deep crimson cloak walking away with a staff, leaving eight stacked cups behind to journey toward misty moonlit peaks. Tarot emblem integrated naturally: eight chalices stacked. COUNT LOCK — EXACTLY 8 CHALICES (hard constraint; count before you draw).
The scene contains exactly 8 chalices — not 7, not 9.
Placement is locked: exactly eight chalices stacked on the rocky ledge as 3 + 3 + 2, with one clearly empty gap between the sixth and the seventh — 3 + 3 + 2 = 8; all eight bowls countable, none cropped by the frame.
...
At the bottom, centered: the title "EIGHT OF CUPS" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
