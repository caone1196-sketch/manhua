# EIGHT OF CUPS (8) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `cups-08` | **Group:** cups
- **Emblem:** eight chalices stacked
- **Phong cách phòng tắm:** Moon-door
...
FIGURE: 23 years old, build: **B** mảnh gọn, bóng dáng lữ khách dứt khoát, hair: deep brown hair tucked behind her ears with a small brass pin, eyes: deep brown, narrow, quyết tâm quay lưng, skin: light olive with glossy wet highlights, signature: sẹo nhỏ hình la bàn trên lòng bàn tay trái, aura: mưa, bước chân, núi xa. Alluring pose: seated in the shallow water facing the viewer, knees together tilted to one side, arms loosely crossed beneath her chest, shoulders glistening with droplets. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Moon-door): in a moon-door bathroom: deep indigo light, an arched doorway in the wet wall opening onto glowing sea water, eight chalices stacked on the ledge beside it — three, three and two, one clear gap between the sixth and the seventh. Tarot emblem integrated naturally: eight chalices stacked. COUNT LOCK — EXACTLY 8 CHALICES (hard constraint; count before you draw).
The scene contains exactly 8 chalices — not 7, not 9.
Placement is locked: exactly eight chalices stacked on the ledge as 3 + 3 + 2 with one clearly empty gap between the sixth and the seventh; all eight bowls countable
