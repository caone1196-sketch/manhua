# THE EMPEROR (IV) — Frameless Wet-Manhwa v2 · mode modern
...
SCENE & SYMBOLISM: a dominant 25-year-old streamer seated with poised posture in an executive leather gaming throne with ram-horn headrest designs, RGB volcanic-red ambient backlighting, glowing PC setup, holding a golden ankh stylus, ram-head sculptures on the desk, barren mountain mural behind. Tarot emblem integrated naturally: a ram's head. COUNT LOCK: This card contains NO loose suit objects in the scene. Do not add random floating or decorative cups, swords, wands, or pentacles.
