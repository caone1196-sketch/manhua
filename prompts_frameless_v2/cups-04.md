# FOUR OF CUPS (4) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `cups-04` | **Group:** cups
- **Emblem:** three chalices and one offered
- **Phong cách phòng tắm:** Still-water zen
...
FIGURE: 22 years old, build: **A** mảnh, dáng ngồi thả lỏng thờ ơ, hair: dark wavy hair falling over her shoulder in contemplative thought, eyes: grey-blue mờ, downturned, chán lơ đãng, skin: fair with glossy wet highlights, signature: nốt ruồi nhỏ trên gò má phải, aura: bóng cây, buồn nhẹ, dòng nước. Alluring pose: kneeling upright on the bath mat, thighs close together, torso arched gracefully back, both arms lifting her wet hair, spine curved like a drawn bow, eyes closed in a soft sigh. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Still-water zen): in a still-water bathroom: a perfectly still square soaking pool, misty grey-blue calm, three chalices standing upright in a row on the stone edge before her and a fourth chalice offered on a small floating wooden tray. Tarot emblem integrated naturally: three chalices and one offered. COUNT LOCK — EXACTLY 4 CHALICES (hard constraint; count before you draw).
The scene contains exactly 4 chalices — not 3, not 5.
Placement is locked: exactly four chalices: three standing upright in a row on the stone edge plus one offered on the floating wooden tray — 3 + 1 = 4; all four bowls visible
