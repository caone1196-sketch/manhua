# TWO OF PENTACLES (2) — Frameless Wet-Manhwa v2

- **Slug:** `pentacles-02` | **Group:** pentacles
- **Emblem:** two pentacles and an infinity ribbon
...
```text
A completely frameless vertical tarot card "TWO OF PENTACLES", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "TWO OF PENTACLES" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
FIGURE: 19 years old, build: **B** mảnh dẻo, vũ công cân bằng, hair: tousled sandy-gold curls bouncing with her dance, eyes: hazel-gold vui, round, lấp lánh, skin: fair with glossy wet highlights, signature: bớt tròn như đồng xu sau tai phải, aura: nhạc đường phố, gió, tiếng cười. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: a joyful 19-year-old young woman dancing on a seaside terrace, juggling two golden pentacles looped inside an infinity ribbon with ships in rolling surf behind. Tarot emblem integrated naturally: two pentacles and an infinity ribbon. COUNT LOCK — EXACTLY 2 PENTACLE COINS (hard constraint; count before you draw).
The scene contains exactly 2 pentacle coins — not 1, not 3.
Placement is locked: exactly two coins, one at each end of the looping infinity ribbon, one in each hand; both discs fully visible against the sky, no third coin.
...
At the bottom, centered: the title "TWO OF PENTACLES" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
