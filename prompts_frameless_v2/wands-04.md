# FOUR OF WANDS (4) — Frameless Wet-Manhwa v2

- **Slug:** `wands-04` | **Group:** wands
- **Emblem:** four wands with a garland
...
```text
A completely frameless vertical tarot card "FOUR OF WANDS", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "FOUR OF WANDS" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
FIGURE: 20 years old, build: **B** mảnh dẻo, eo vũ công, tay nâng duyên dáng, hair: blue-black hair piled high in a floral-pinned braided updo, eyes: dark cherry-violet, round, lấp lánh tinh nghịch, skin: light olive with glossy wet highlights, signature: chùm tàn nhang hình bông hoa trên vai trái, aura: nến, vũ hội, cánh hoa. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: four garlanded wands forming a festive canopy, two graceful young women dancing gently beneath it, both draped in diaphanous transparent silk veils and both with fair skin tones — one porcelain-skinned with flowing honey-gold hair and one rosy ivory-skinned with deep auburn ringlets, each with a distinct face and figure — a manor beyond. Tarot emblem integrated naturally: four wands with a garland. COUNT LOCK — EXACTLY 4 WANDS (hard constraint; count before you draw).
The scene contains exactly 4 wands — not 3, not 5.
Placement is locked: exactly four wands as the four corner posts of a canopy — two on the left, two on the right — 2 + 2 = 4; draw the two rear posts slightly taller than the two front posts so no post is hidden behind another; all four shafts fully visible from ground to tip, their tops joined by one flower garland.
...
At the bottom, centered: the title "FOUR OF WANDS" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
