# KNIGHT OF SWORDS (N) — Frameless Wet-Manhwa v2 · mode modern
...
SCENE & SYMBOLISM: the card's symbolism re-staged in a modern luxury penthouse streamer studio: a sword over a horse rendered as a glowing holographic emblem above her, PC monitors and RGB neon ambient lighting, the suit objects arranged on her streaming desk, night city skyline bokeh through floor-to-ceiling windows. Tarot emblem integrated naturally: a sword over a horse. COUNT LOCK — EXACTLY 1 SWORD (hard constraint; count before you draw).
