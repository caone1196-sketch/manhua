# KNIGHT OF SWORDS (N) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `swords-knight` | **Group:** swords
- **Emblem:** a sword over a horse
- **Phong cách phòng tắm:** Gale force
...
FIGURE: 21 years old, build: **B** mảnh săn, dáng phi thẳng tấn công, hair: dark hair streaming wildly back, pinned with a slim silver wing hairpin, eyes: blazing grey-blue, narrow, hung hãn, skin: sand with glossy wet highlights, signature: xăm nhỏ hình đôi cánh bạc trên vai trái, aura: sấm vó, gió thét, thép. Alluring pose: seated sideways on the tub rim leaning back on one straight arm, chest lifted, one knee drawn up while the other leg trails toe-deep in the water, wet hair cascading down her back. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Gale force): in a gale-force bathroom: an open-air wet room with wind blasting a sheer curtain sideways, cold electric light, a horseshoe emblem glowing on the wall, one crystal blade pointed forward like a lance in her hand. Tarot emblem integrated naturally: a sword over a horse. COUNT LOCK — EXACTLY 1 sword (hard constraint; count before you draw).
The scene contains exactly 1 sword — not 0, not 2.
Placement is locked: exactly one crystal blade pointed forward like a lance in her hand; no other blade
