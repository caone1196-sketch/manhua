# KNIGHT OF SWORDS (N) — Frameless Wet-Manhwa v2

- **Slug:** `swords-knight` | **Group:** swords
- **Emblem:** a sword over a horse
...
```text
A completely frameless vertical tarot card "KNIGHT OF SWORDS", edge-to-edge illustration: no decorative borders, no card frame, no banner ribbon, no numbers, no Roman numerals. The only text is the title "KNIGHT OF SWORDS" centered at the very bottom in the same antique-gold serif lettering as the style reference card.
...
FIGURE: 21 years old, build: **B** mảnh săn, dáng phi thẳng tấn công, hair: dark hair streaming wildly back from beneath an open winged helmet, eyes: blazing grey-blue, narrow, hung hãn, skin: sand with glossy wet highlights, signature: xăm nhỏ hình mũ giáp cánh trên vai trái, aura: sấm vó, gió thét, thép. Pose: graceful S-curve contrapposto where the scene allows (hip popped, back slightly arched, one knee softly bent, barefoot); blushing cheeks, cat eyeliner, softly parted lips with a confident gentle smile.

SCENE & SYMBOLISM: a fierce 21-year-old female knight in gleaming steel armor charging on a galloping horse, sword held high into the storm winds. Tarot emblem integrated naturally: a sword over a horse. COUNT LOCK — EXACTLY 1 SWORD (hard constraint; count before you draw).
The scene contains exactly 1 sword — not 0, not 2.
Placement is locked: exactly one sword, pointed forward like a lance; no other blade.
...
At the bottom, centered: the title "KNIGHT OF SWORDS" in antique-gold serif lettering matching reference 1. No numbers, no Roman numerals, no other text, no frame, no border, no banner, no watermark, no signature. Masterpiece manhwa illustration, portrait 7:12.
```
