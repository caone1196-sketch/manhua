# JUSTICE (XI) — Frameless Wet-Manhwa v2 · mode modern
...
SCENE & SYMBOLISM: the card's symbolism re-staged in a modern luxury penthouse streamer studio: balanced golden scales rendered as a glowing holographic emblem above her, PC monitors and RGB neon ambient lighting, the suit objects arranged on her streaming desk, night city skyline bokeh through floor-to-ceiling windows. Tarot emblem integrated naturally: balanced golden scales. COUNT LOCK — EXACTLY 1 SWORD (hard constraint; count before you draw).
The scene contains exactly 1 sword — not 0, not 2.
Placement is locked: exactly one sword, held upright in her left hand; no other blade on the card.
