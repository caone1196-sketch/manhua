# JUSTICE (XI) — Frameless Wet-Manhwa v2
...
SCENE & SYMBOLISM: a statuesque bare-shouldered queen, an opaque silk sash sliding off one shoulder, a sword upright in one hand and balanced scales in the other, seated on a stone throne between pillars. Tarot emblem integrated naturally: balanced golden scales. COUNT LOCK — EXACTLY 1 SWORD (hard constraint; count before you draw).
