# FIVE OF PENTACLES (5) — Frameless Wet-Manhwa v2.2 · mode bathroom

- **Slug:** `pentacles-05` | **Group:** pentacles
- **Emblem:** five pentacles in a church window
- **Phong cách phòng tắm:** Snow stained-glass
...
FIGURE: 20 years old, build: **A** mảnh, dáng co mình dưới cửa sổ nhà thờ, hair: long windswept dark-brown hair catching falling snow, eyes: icy-grey nhạt, doe, run rẩy mệt mỏi, skin: porcelain with glossy wet highlights, signature: bớt trắng như sương trên cổ, aura: tuyết, đói, cửa sổ sáng. Alluring pose: rising on tiptoe in a full-body stretch, arms overhead and intertwined, back arched, her whole figure one long alluring arc of light and water. Barefoot; blushing cheeks, cat eyeliner, softly parted lips.

SCENE & SYMBOLISM (Snow stained-glass): in a snow-window bathroom: frosted pale-blue tile, warm tub steam against cold light, a grand stained-glass window with five golden pentacle coins set into the glass in a quincunx — one top center, two on the middle row, two on the bottom row. Tarot emblem integrated naturally: five pentacles in a church window. COUNT LOCK — EXACTLY 5 PENTACLE COINS (hard constraint; count before you draw).
The scene contains exactly 5 pentacle coins — not 4, not 6.
Placement is locked: exactly five coins set in the stained-glass window in a quincunx — one at the top center, two on the middle row, two on the bottom row, 1 + 2 + 2 = 5; all five separate and countable
