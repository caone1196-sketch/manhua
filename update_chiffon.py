...
# Form-fitting sheer chiffon micro-bikini directive
CHIFFON_DIRECTIVE = "wearing a form-fitting sheer white chiffon micro-bikini hugging her skin closely, outlining bust contours and skin highlights beneath the thin translucent fabric, white choker, and sheer thigh-high stockings"
...
for c in cards_data['cards']:
    ...
    scene = c['scene']
    char_spec = f"She is {c.get('age', '20 years old')}, {c.get('build', 'slender waist with curvy feminine silhouette')}, with {c.get('hair', 'flowing golden hair')}, {c.get('eyes', 'alluring eyes')}, glowing porcelain skin, {CHIFFON_DIRECTIVE}."
...
print("Updated cards.json with form-fitting sheer chiffon micro-bikini directive!")
